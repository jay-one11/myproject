...
public class BoardController {
	...
	@GetMapping("/page")
    public ResponseEntity<PageNavigation> makePageNavigation(BoardParameterDto boardParameterDto) throws Exception {
        logger.info("deleteArticle - 호출");
        return new ResponseEntity<PageNavigation>(boardService.makePageNavigation(boardParameterDto), HttpStatus.OK);
    } 
